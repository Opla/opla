...
export const defaultShortcuts: KeyBinding[] = [
  ...
  {
    command: ShortcutIds.RESEND_MESSAGE,
    keys: ['mod+o'],
  ...
  },
  {
    ...
    keys: ['mod+delete'],
    description: 'Delete last message and sibling',
    scope: 'threads',
  },
  {
    command: ShortcutIds.EDIT_MESSAGE,
    keys: ['mod+m'],
    description: 'Edit last input message',
    scope: 'threads',
  },
  {
    command: ShortcutIds.COPY_MESSAGE,
    keys: ['mod+b'],
    description: 'Copy last response message',
    scope: 'threads',
  },
