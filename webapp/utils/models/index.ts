...
const InnerModelSchema: any = z.lazy(() =>
  z.object({
    id: z.string().describe("model's unique identifier").optional(),
    name: z.string().describe('The name of the model'),
    created_at: z.string().datetime().describe('creation date of the model').optional(),
    updated_at: z.string().datetime().describe('updated date of the model').optional(),
    ...
    creator: z.string().describe('The creator of the model, it is a unique identifier').optional(),
    author: z
      .union([
        z.string(),
        z.object({
    ...
    recommendations: z.string().describe('The recommendations of the model').optional(),
    ...
    model_type: z
      ...
      .optional(),
    library: z.enum(['PyTorch', 'GGUF']).describe('The library of the model').optional(),
    tensor_type: z
    ...
    quantization: z
      ...
      .optional(),
    bits: z.number().int().describe('The number of bits used in the model').optional(),
    size: z.number().describe("The size in Go of the model's file").optional(),
    max_ram: z.number().describe('The maximum RAM used for the model').optional(),
    repository: z
      .union([
        z.string().url(),
        z.object({
