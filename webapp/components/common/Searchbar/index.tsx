      ...
      <div className="flex gap-2 p-1">
        ...
        <div className="border-input focus-within:ring-ring flex w-full items-center gap-2 rounded-md border px-2 focus-within:border-transparent focus-within:ring-1">
          ...
          <Input
            ...
            className="focus-visible:ring-none m-0 flex-1 overflow-hidden border-none p-0 shadow-none focus-visible:shadow-none focus-visible:ring-0 focus-visible:outline-hidden"
            autoFocus
          />
